...
В рамках дипломного проекта необходимо были реализованы ключевые компоненты игры (файл game.js данного репозитория). 

Ссылка на реализацию в песочнице https://repl.it/@elenapushkareva/js-game

Среда автоматизированного тестирования вашего кода подтверждает созданные компоненты на соответствие требованиям.

Описание исходного задания по проекту:
----
